UNIX BUILD NOTES
====================
Some notes on how to build Partnercoin Core in Unix.
...
memory available when compiling Partnercoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Partnercoin Core without wallet.
...
If you want to build Partnercoin-Qt, make sure that the required packages for Qt development
...
As mentioned above, when maintaining portability of the wallet between the standard Partnercoin Core distributions and independently built
