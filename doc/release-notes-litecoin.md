Partnercoin Core version 0.16.0 is now available from:
...
### BIP173 (Bech32) Address support ("partn1..." addresses)
...
Partnercoin Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Partnercoin Core is now 4.8. No effort will be
...
* A new field `iswitness` is True for P2WPKH and P2WSH addresses ("partn1..." addresses), but not for P2SH-wrapped segwit addresses (see below).
