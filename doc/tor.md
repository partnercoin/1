...
It is possible to run Partnercoin as a Tor hidden service, and connect to such services.
...
The first step is running Partnercoin behind a Tor proxy. This will already make all
...
Partnercoin Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if Partnercoin Core is listening (`-listen`), and
