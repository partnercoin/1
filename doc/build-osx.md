...
Partnercoin Core is now available at `./src/litecoind`

Before running, it's recommended you create an RPC configuration file.

    echo -e "rpcuser=litecoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Partnercoin/litecoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Partnercoin/litecoin.conf"
...
You can monitor the download process by looking at the debug.log file:
    ...
    tail -f $HOME/Library/Application\ Support/Partnercoin/debug.log
