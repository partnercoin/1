...
The Partnercoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Partnercoin Core requires ZeroMQ API version 4.x or
...
using. Partnercoind appends an up-counting sequence number to each
