...
Run this script from the directory containing the litecoin, gitian-builder, gitian.sigs.partn, and litecoin-detached-sigs.
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs.partn/ ../litecoin/contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.partn/ ../litecoin/contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.partn/ ../litecoin/contrib/gitian-descriptors/gitian-osx.yml
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.partn/ ../litecoin/contrib/gitian-descriptors/gitian-win-signer.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.partn/ ../litecoin/contrib/gitian-descriptors/gitian-osx-signer.yml
