...
#if defined(NDEBUG)
# error "Partnercoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Partnercoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PARTN additional fees, %d delta bytes\n",
